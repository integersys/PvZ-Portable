...
static Image* GetImageCompat(ResourceManager& theManager, const char* thePrimaryId, const char* theFallbackId)
{
	Image* anImage = theManager.GetImage(thePrimaryId);
	if (anImage != nullptr)
		return anImage;

	anImage = theManager.LoadImage(theFallbackId);
	if (anImage != nullptr)
		return anImage;

	return theManager.GetImageThrow(thePrimaryId);
}
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager* theManager)
{
	...
	try
	{
		IMAGE_ACHEESEMENTS_BACK_HIGHLIGHT = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_BACK_HIGHLIGHT", "IMAGE_ACHIEVEMENT_BACK_GLOW");
		IMAGE_ACHEESEMENTS_BEJEWELED = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_BEJEWELED", "IMAGE_ACHIEVEMENT_BEJEWELED");
		IMAGE_ACHEESEMENTS_BOOKWORM = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_BOOKWORM", "IMAGE_ACHIEVEMENT_BOOKWORM");
		IMAGE_ACHEESEMENTS_CHINA = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_CHINA", "IMAGE_ACHIEVEMENT_TILE_CHINA");
		IMAGE_ACHEESEMENTS_CHUZZLE = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_CHUZZLE", "IMAGE_ACHIEVEMENT_CHUZZLE");
		IMAGE_ACHEESEMENTS_HOLE_TILE = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_HOLE_TILE", "IMAGE_ACHIEVEMENT_TILE");
		IMAGE_ACHEESEMENTS_ICONS = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_ICONS", "IMAGE_ACHIEVEMENTS_PORTRAITS");
		IMAGE_ACHEESEMENTS_MORE_BUTTON = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_MORE_BUTTON", "IMAGE_ACHIEVEMENT_MORE");
		IMAGE_ACHEESEMENTS_MORE_BUTTON_HIGHLIGHT = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_MORE_BUTTON_HIGHLIGHT", "IMAGE_ACHIEVEMENT_MORE_HIGHLIGHT");
		IMAGE_ACHEESEMENTS_MORE_ROCK = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_MORE_ROCK", "IMAGE_ACHIEVEMENT_ROCK");
		IMAGE_ACHEESEMENTS_PEGGLE = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_PEGGLE", "IMAGE_ACHIEVEMENT_PEGGLE");
		IMAGE_ACHEESEMENTS_PIPE = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_PIPE", "IMAGE_ACHIEVEMENT_PIPE");
		IMAGE_ACHEESEMENTS_TOP_BUTTON = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_TOP_BUTTON", "IMAGE_ACHIEVEMENT_TOP");
		IMAGE_ACHEESEMENTS_TOP_BUTTON_HIGHLIGHT = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_TOP_BUTTON_HIGHLIGHT", "IMAGE_ACHIEVEMENT_TOP_HIGHLIGHT");
		IMAGE_ACHEESEMENTS_ZUMA = GetImageCompat(aMgr, "IMAGE_ACHEESEMENTS_ZUMA", "IMAGE_ACHIEVEMENT_ZUMA");
		...
		IMAGE_QUICKPLAY_BACK_BUTTON = aMgr.GetImage("IMAGE_QUICKPLAY_BACK_BUTTON");
		IMAGE_QUICKPLAY_BACK_BUTTON_HIGHLIGHT = aMgr.GetImage("IMAGE_QUICKPLAY_BACK_BUTTON_HIGHLIGHT");
		IMAGE_QUICKPLAY_MINIGAMES_BUTTON = aMgr.GetImage("IMAGE_QUICKPLAY_MINIGAMES_BUTTON");
		IMAGE_QUICKPLAY_MINIGAMES_BUTTON_HIGHLIGHT = aMgr.GetImage("IMAGE_QUICKPLAY_MINIGAMES_BUTTON_HIGHLIGHT");
		IMAGE_QUICKPLAY_MINIGAMES_CLOUD = aMgr.GetImage("IMAGE_QUICKPLAY_MINIGAMES_CLOUD");
		IMAGE_QUICKPLAY_PUZZLES_BUTTON = aMgr.GetImage("IMAGE_QUICKPLAY_PUZZLES_BUTTON");
		IMAGE_QUICKPLAY_PUZZLES_BUTTON_HIGHLIGHT = aMgr.GetImage("IMAGE_QUICKPLAY_PUZZLES_BUTTON_HIGHLIGHT");
		IMAGE_QUICKPLAY_PUZZLES_CLOUD = aMgr.GetImage("IMAGE_QUICKPLAY_PUZZLES_CLOUD");
		IMAGE_QUICKPLAY_SURVIVAL_BUTTON = aMgr.GetImage("IMAGE_QUICKPLAY_SURVIVAL_BUTTON");
		IMAGE_QUICKPLAY_SURVIVAL_BUTTON_HIGHLIGHT = aMgr.GetImage("IMAGE_QUICKPLAY_SURVIVAL_BUTTON_HIGHLIGHT");
		IMAGE_QUICKPLAY_SURVIVAL_CLOUD = aMgr.GetImage("IMAGE_QUICKPLAY_SURVIVAL_CLOUD");
		...
		IMAGE_SELECTORSCREEN_ACHIEVEMENTS_BG = GetImageCompat(aMgr, "IMAGE_SELECTORSCREEN_ACHIEVEMENTS_BG", "IMAGE_ACHIEVEMENT_SELECTOR_TILE");
		IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL = GetImageCompat(aMgr, "IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL", "IMAGE_ACHIEVEMENT_BUTTON");
		IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL_PRESS = GetImageCompat(aMgr, "IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL_PRESS", "IMAGE_ACHIEVEMENT_HIGHLIGHT");
		...
		IMAGE_SELECTORSCREEN_MOREWAYSTOPLAY_BG = aMgr.GetImage("IMAGE_SELECTORSCREEN_MOREWAYSTOPLAY_BG");
